...
\fxnote{Objetivos, desde mi punto de vista: desarrollar una aplicación para iPhone que (i) permita navegar a través de los mercados de apuestas de BF (ii) permita realizar apuestas (iii) asesore al usuario (de forma incluso automática) sobre posibilidades de trading}

...
\subsection{Arquitectura de la aplicación}	
   ...
   \end{figure}
    ...
    En la figura \ref{fig:esquema-MVC} podemos ver un esquema del modelo Vista Controlador usado. % \fxnote{de la arquitectura?}.
     Los controladores de vista se encargan de recoger los eventos de la aplicación principalmente inputs del usuario. % \fxnote{eventos?}. 
